...
class UIManager:
    ...
    def __init__(
        ...
        self._theme = get_theme(Theme.CLASSIC)
    ...
    def render_main_menu(self) -> None:
        ...
        title = self.get_font("title").render("SNAKE", True, colors.accent)
        title_rect = title.get_rect(center=(width // 2, height // 4))
        self.screen.blit(title, title_rect)

        subtitle = self.get_font("small").render("Classic Arcade Game", True, colors.text_secondary)
